...
# 参数解析
parser = argparse.ArgumentParser(description='为Sparse R-CNN模型生成热力图')
parser.add_argument('--k', type=int, default=3, help='热力图数量K，默认为3')
args = parser.parse_args()

# 配置路径
FEATURES_FILE = r'E:\Code\Partitioned Module Annotation\features\sparse_rcnn_features.pkl'
HEATMAPS_DIR = r'E:\Code\Partitioned Module Annotation\heatmaps\sparse_rcnn'

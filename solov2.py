...
# 参数解析
parser = argparse.ArgumentParser(description='为SOLOv2模型生成热力图')
parser.add_argument('--k', type=int, default=3, help='热力图数量K，默认为3')
args = parser.parse_args()

# 配置路径
FEATURES_FILE = r"E:\Code\Partitioned Module Annotation\features\solov2_features.pkl"
HEATMAPS_DIR = r"E:\Code\Partitioned Module Annotation\heatmaps\solov2"
    ...
    for cluster_id in range(k):
        ...
        if module_layers:
            ...
            module_avg = process_module_features(
                ...
                module_layers,
                data['features'],  # 注意：SOLOv2使用'features'而不是'module_features'
                data['original_imgs']
            )

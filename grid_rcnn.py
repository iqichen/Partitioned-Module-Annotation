...
# 参数解析
parser = argparse.ArgumentParser(description='为Grid R-CNN模型生成热力图')
parser.add_argument('--k', type=int, default=3, help='热力图数量K，默认为3')
args = parser.parse_args()

# 配置路径
FEATURES_FILE = r'E:\Code\Partitioned Module Annotation\features\grid_rcnn_features.pkl'
HEATMAPS_DIR = r'E:\Code\Partitioned Module Annotation\heatmaps\grid_rcnn'
...
def generate_heatmap(feat_map, orig_img, upsample_ratio):
    ...
    blended = cv2.addWeighted(orig_img, 0.7, heatmap_img, 0.3, 0)

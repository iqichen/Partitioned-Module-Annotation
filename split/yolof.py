...
# 参数解析
parser = argparse.ArgumentParser(description='使用K-means聚类拆分YOLOF模型')
...
# 初始化配置
config_file = r'E:\Code\Partitioned Module Annotation\mmdetection\configs\yolof\yolof_r50-c5_8xb8-1x_coco.py'
checkpoint_file = r'E:\Code\Partitioned Module Annotation\mmdetection\checkpoints\yolof_r50_c5_8x8_1x_coco_20210425_024427-8e864411.pth'
...
def prepare_image(img):
    img = mmcv.imresize(img, (640, 640))  # 对齐YOLOF输入尺寸
...
# 保存中间数据
output_file = os.path.join(SAVE_DIR, f'yolof_features_{args.k}.pkl')

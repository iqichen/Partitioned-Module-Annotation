...
# 参数解析
parser = argparse.ArgumentParser(description='使用K-means聚类拆分Mask RCNN模型')
...
# 初始化配置
config_file = r'E:\Code\Partitioned Module Annotation\mmdetection\configs\mask_rcnn\mask-rcnn_r50_fpn_1x_coco.py'
checkpoint_file = r'E:\Code\Partitioned Module Annotation\mmdetection\checkpoints\mask_rcnn_r50_fpn_1x_coco_20200205-d4b0c5d6.pth'
...
# 保存中间数据
output_file = os.path.join(SAVE_DIR, f'mask_rcnn_features_{args.k}.pkl')

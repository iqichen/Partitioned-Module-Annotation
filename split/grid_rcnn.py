...
# 参数解析
parser = argparse.ArgumentParser(description='使用K-means聚类拆分Grid RCNN模型')
...
# 初始化配置
config_file = r'E:\Code\Partitioned Module Annotation\mmdetection\configs\grid_rcnn\grid-rcnn_r50_fpn_gn-head_1x_coco.py'
checkpoint_file = r'E:\Code\Partitioned Module Annotation\mmdetection\checkpoints\grid_rcnn_r50_fpn_gn-head_2x_coco_20200130-6cca8223.pth'
...
# 保存中间数据
output_file = os.path.join(SAVE_DIR, f'grid_rcnn_features_{args.k}.pkl')

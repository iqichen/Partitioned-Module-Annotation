...
# 参数解析
parser = argparse.ArgumentParser(description='使用K-means聚类拆分MS RCNN模型')
...
# 初始化配置
config_file = r'E:\Code\Partitioned Module Annotation\mmdetection\configs\ms_rcnn\ms-rcnn_r50_fpn_1x_coco.py'
checkpoint_file = r'E:\Code\Partitioned Module Annotation\mmdetection\checkpoints\ms_rcnn_r50_caffe_fpn_1x_coco_20200702_180848-61c9355e.pth'
...
# 保存中间数据
output_file = os.path.join(SAVE_DIR, f'ms_rcnn_features_{args.k}.pkl')

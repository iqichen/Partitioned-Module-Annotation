...
# 参数解析
parser = argparse.ArgumentParser(description='使用K-means聚类拆分Sparse RCNN模型')
...
# 初始化配置
config_file = r'E:\Code\Partitioned Module Annotation\mmdetection\configs\sparse_rcnn\sparse-rcnn_r50_fpn_1x_coco.py'
checkpoint_file = r'E:\Code\Partitioned Module Annotation\mmdetection\checkpoints\sparse_rcnn_r50_fpn_1x_coco_20201222_214453-dc79b137.pth'
...
def prepare_image(img):
    """Sparse R-CNN 预处理（保持长宽比 800x1333）"""
...
# 保存中间数据
output_file = os.path.join(SAVE_DIR, f'sparse_rcnn_features_{args.k}.pkl')
